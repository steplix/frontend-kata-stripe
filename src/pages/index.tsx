        ...
        <section>
          <article className="text-white w-full h-full flex flex-col text-center space-y-8 items-center justify-center border-white border-[0.5px] p-4">
            ...
            <p className="lg:max-w-4xl max-w-xs">
              ...
              Perferendis consequuntur, dolores, deleniti ipsam iure blanditiis
              eum quam cum distinctio quidem quis amet ut voluptatem dolorum
              nisi! Esse inventore molestiae doloremque neque, sequi sunt cum
              temporibus ipsam aliquid totam distinctio deleniti? Esse quod
              fugit velit vitae. Dolorem odit quibusdam ipsum libero!
            </p>
          </article>
        </section>
      </main>
      <footer className="w-full flex items-center justify-center p-4 bg-[#180228] border-white border-t-[0.5px] mt-4"></footer>
    </div>
  );
};
